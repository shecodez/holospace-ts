<template>
  <div class="mx-4">
    <div class="mb-8">
      <h3 class="text-xs font-bold uppercase py-4">Background Image</h3>
      <div class="relative">
      ...
      <div class="overflow-hidden">
        <div class="h-24 hs-bg-gradient" :class="noBgGradient ? 'filter grayscale cursor-not-allowed' : ''"></div>
      </div>
      <button :disabled="noBgGradient" class="btn btn-primary mt-4 disabled:opacity-40">
    ...
    <div class="my-8 border-t hs-border">
      ...
      <ul class="grid grid-flow-col grid-cols-4 gap-4">
