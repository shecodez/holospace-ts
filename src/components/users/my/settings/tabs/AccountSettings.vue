<template>
  <section class="flex flex-wrap rounded bg-gray-300 dark:bg-gray-700 p-2 md:p-4">
    ...
    <div class="flex-1 space-y-4 p-4 overflow-hidden">
      <div class="flex items-center">
        <div>
          <label class="hs-h3">HoloTag</label>
          <h4 class="hs-h4">
      ...
      <div class="flex items-center">
        <div>
          <label class="hs-h3 flex items-center">
            {{ t('email') }}
      ...
      <div class="flex items-center">
        <div>
          <label class="hs-h3">{{ t('phone_number') }}</label>
          <h4 class="hs-h4">
  ...
  <section class="auth py-6">
    <h3 class="hs-h3 mb-4">{{ t(`${l10n}.password_and_2fa`) }}</h3>

    <button class="btn btn-primary mb-4">{{ t(`${l10n}.change_password`) }}</button>

    <div class="py-2">
      <h4 class="hs-h4">{{ t(`${l10n}.two_factor_authentication`) }}</h4>
      <p>{{ t(`${l10n}.protect_your_holospace_account_`) }}</p>
      <!-- <button class="btn btn-primary mt-4 mb-2">{{ t(`${l10n}.enable_2fa`) }}</button> -->
    </div>
  </section>

  <section class="danger-zone py-6 border-t border-red-500 border-opacity-40">
    <h3 class="hs-h3 text-red-500 mb-4">{{ t('danger_zone') }}</h3>
